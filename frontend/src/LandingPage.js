...
const LandingPage = () => {
  return (
    <div className="flex flex-col min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <header className="flex flex-col items-center justify-center text-center bg-blue-50 py-20">
        <h1 className="text-5xl font-bold text-gray-800 leading-tight mb-4">Empower Your Learning Journey</h1>

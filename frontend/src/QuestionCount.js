    ...
    <div className="flex flex-col items-center justify-center h-screen bg-white">
      ...
      <div className="w-full max-w-2xl mx-auto">
        ...
        <div className="grid grid-cols-3 gap-4 mb-8">
          <button className="border border-gray-300 p-4 rounded-lg text-black">10</button>
          <button className="border border-gray-300 p-4 rounded-lg text-black">20</button>
          <button className="border border-gray-300 p-4 rounded-lg text-black">30</button>
        </div>
